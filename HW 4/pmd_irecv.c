...
----------------------------------------------------------------------*/
	...
	for (kd = 0; kd < 3; kd++)
	{
		...
		for (kdd = 0; kdd < 2; kdd++)
		{
			...
			// INFORMATION ABOUT NUMBER OF ATOMS TO BE SENT
			/* Even node: send & recv */
